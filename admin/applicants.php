...
$rows = $db->arraybuilder()->paginate("applicants a", $page, "u.user_name, u.email, u.password, u.reg_no, a.f_name, a.l_name, a.field, a.img, a.gender, a.address, a.phone, a.date_of_birth, a.id");
...
<div class="container-fluid">
        ...
        <div class="container d-flex justify-content-center filter-form">
        <!-- Filters -->
    ...
    <div class="row my-2">
        <div class="col-lg-6">
            <div id="export-section" class="text-left">
                <a href="export_applicants.php"><button class="btn btn-sm btn-primary py-2">Export to CSV <i class="glyphicon glyphicon-export"></i></button></a>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_applicant.php?operation=create" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Add new</a>
            </div>
        </div>
    </div>
    <div class="row mt-3 mx-auto">
        ...
        <table class="table table-striped table-bordered table-condensed">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_applicant.php?applicant_id=<?php echo $row['reg_no']; ?>&operation=edit" class="btn btn-primary"><i class="fa fa-edit fa-fw"></i></a>
        ...
        <?php echo paginationLinks($page, $total_pages, 'applicants.php'); ?>
        </div>
        <!-- //Pagination -->
    </div>
</div>
